...
class ImageGenerationSessionStates:
    ...
    def get_model_type() -> ImageGenerationModelEnum:
        return st.session_state.get(
            ImageGenerationSessionStateEnum.IMAGE_GENERATION_MODEL_TYPE.name,
            ImageGenerationSessionStateDefaults.get_MODEL_TYPE(),
        )

    @staticmethod
    def set_model_type(model_type: ImageGenerationModelEnum) -> None:
        st.session_state[ImageGenerationSessionStateEnum.IMAGE_GENERATION_MODEL_TYPE.name] = model_type
    ...
    def get_size_type() -> ImageGenerationSizeEnum:
        return st.session_state.get(
            ImageGenerationSessionStateEnum.IMAGE_GENERATION_SIZE_TYPE.name, 
            ImageGenerationSessionStateDefaults.get_SIZE_TYPE(),
        )

    @staticmethod
    def set_size_type(size_type: ImageGenerationSizeEnum) -> None:
        st.session_state[ImageGenerationSessionStateEnum.IMAGE_GENERATION_SIZE_TYPE.name] = size_type
    ...
    def get_quality_type() -> ImageGenerationQualityEnum:
        return st.session_state.get(
            ImageGenerationSessionStateEnum.IMAGE_GENERATION_QUALITY_TYPE.name, 
            ImageGenerationSessionStateDefaults.get_QUALITY_TYPE(),
        )

    @staticmethod
    def set_quality_type(quality_type: ImageGenerationQualityEnum) -> None:
        st.session_state[ImageGenerationSessionStateEnum.IMAGE_GENERATION_QUALITY_TYPE.name] = quality_type
    ...
    def get_user_prompt() -> str:
        return st.session_state.get(ImageGenerationSessionStateEnum.IMAGE_GENERATION_USER_PROMPT.name, None)

    @staticmethod
    def set_user_prompt(user_prompt: str) -> None:
        st.session_state[ImageGenerationSessionStateEnum.IMAGE_GENERATION_USER_PROMPT.name] = user_prompt
    ...
    def get_image_url() -> str:
        return st.session_state.get(ImageGenerationSessionStateEnum.IMAGE_GENERATION_IMAGE_URL.name, None)

    @staticmethod
    def set_image_url(image_url: str) -> None:
        st.session_state[ImageGenerationSessionStateEnum.IMAGE_GENERATION_IMAGE_URL.name] = image_url
